...
// lib databaseلربط مع الداتا بيز real time علشان اضع داتا بها
  ...
  Widget build(BuildContext context) {
    ...
    final dataShow = referenceDatase.reference();
                      ...
                      FlutterSwitch(
                        ...
                        onToggle: (val) {
                          setState(() {
                            ...
                            if (val) {
                              dataShow //استخدام كائن من كلاس الداتا نفسة علشان ادخل بيانات
                                  .child(
                                      'DataShow') //ادخال بيانات باسم رئيسي(اب) للبيانات الفرعية

...
// lib databaseلربط مع الداتا بيز real time علشان اضع داتا بها
  ...
  Widget build(BuildContext context) {
    ...
    final curtain = referenceDatase.reference();
                      ...
                      FlutterSwitch(
                        ...
                        onToggle: (val) {
                          setState(() {
                            ...
                            if (val) {
                              curtain //استخدام كائن من كلاس الداتا نفسة علشان ادخل بيانات
                                  .child(
                                      'Curtain') //ادخال بيانات باسم رئيسي(اب) للبيانات الفرعية
